...
async function loadPost(postId) {
  try {
    ...
    const themeTitileDivElement = createElements("div","",themContentDivElement,{class: "theme-title",});
    const themeNameWrapperDivElement = createElements("div", "", themeTitileDivElement, {class: "theme-name-wrapper",});
    ...
    for (const comment of Object.values(comments)) {
      ...
      const userCommentDivElement = createElements("div", "", commentDivElement, {class: "user-comment",});
      const topicNameWrapper = createElements("div", "", userCommentDivElement, {class: "topic-name-wrapper",});
      const topicNameDivElement = createElements("div", "", topicNameWrapper, {class: "topic-name",});
      ...
      const postContentDivElement = createElements("div", "", topicNameDivElement, {class: "post-content",});
      createElements("p", comment.content, postContentDivElement, {});

    }

    const asnwerCommentDivElement = createElements( "div", "", themContentDivElement, {class: "answer-comment",});
    ...
    const divElementAnswer = createElements("div", "", asnwerCommentDivElement, {class: "answer",});
    ...
    const labeElement = createElements("label", "", formDivElement, {for: "username",});
    labeElement.innerHTML = `Username <span class='red'>*</span>`;
    createElements("input", "", formDivElement, { type: "text", name: "username", id: "username",});
    createElements("button", "Post", formAnswerElement, {id: "postButton",});
